...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-60ed9058');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-60ed9058');}
...
function clearFlash(){dieView.classList.remove('rl-win-60ed9058');dieView.classList.remove('rl-lose-60ed9058');if(frameEl){frameEl.classList.remove('rl-win-60ed9058');frameEl.classList.remove('rl-lose-60ed9058');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-60ed9058');if(frameEl){frameEl.classList.add('rl-win-60ed9058');}}else{dieView.classList.add('rl-lose-60ed9058');if(frameEl){frameEl.classList.add('rl-lose-60ed9058');}}
...
var brandEl=document.querySelector('.rl-brand-60ed9058');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
